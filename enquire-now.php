...
if (isset($_POST['fsub']) && $_POST['fsub'] == 1) {
	...
	if (checkIssetNotEmpty($_SESSION['u_id']) && $_SESSION['u_id'] != '') {
		...
		if ($numsrow > 0) {
			$userData = $sq->fearr($catData);
		   
		} 
		$snf_user = $_SESSION['firstName'] . ' ' . $_SESSION['lastName'] . ' ' . $_SESSION['com_emailAddress']. ' ' . $_SESSION['customerID'];
	}

    $insertSql = "INSERT INTO rollco_enquirenow SET name='" . $username . "',email='" . $emailid . "',comments='" . $comments . "',cust_ip='" . $_SERVER['REMOTE_ADDR'] . "',mobile='".$mobile_no."',user_info='".$snf_user."',user_browser='".$_SERVER['HTTP_USER_AGENT'] ."',user_platform='".$plateform."',user_cntry='".$userData['Country']."',user_county='".$userData['com_state']."',user_city='".$userData['com_city']."'";
...
";
        ...
        $message2 = "Thank you for enquiring about us. We will get back to you shortly.";

// Additional headers

        if ($_SERVER['HTTP_HOST'] != 'localhost') {
            mail('info@rollingcomponents.com', $subject, $message1, $usr_headers);
        ...
        <section class="clearfix cataloGue">
                    ...
                    <div class="container ">
                        <div class="row pt-5 ">
                            <div class="col-12 text-center">
                                <h2 class="text-white pb-2">ENQUIRE NOW <hr></h2>

                            </div>
                        </div>
                        <div class="row pt-3 justify-content-center  pl-4 pr-4">
                            <div class="col-md-10 col-lg-6 col-sm-12 col-12">
                                <div class="row pt-4 justify-content-center d-flex soilWork"> <a href="https://www.facebook.com/rollco1979/" class="col-3 font18 text-white" target="_blank"><i class="pr-2"><img src="images/facebook-b.svg" alt="Facebook"></i> Facebook</a> 
                                    <a href="https://twitter.com/rollingcomp" class="col-3 font18 text-white" target="_blank"><i class="pr-2"><img src="images/twitter-b.svg" alt="Twitter"></i> Twitter</a>
                                     <a href="https://www.youtube.com/channel/UCKOi7APb9LtAFX_pFFs0yMA/" class="col-3 font18 text-white" target="_blank"><i class="pr-2"><img src="images/youtube.svg" alt="Youtube"></i> Youtube</a> </div>
                            </div>
                        </div>
                                ...
                                <form method="post" id="contact_us_form">
                                    <div class="row  pb-5">
                                        ...
                                        <div class="col-sm-4 pb-4 pr-md-4">
                                            <input type="text" name="user_name" id="user_name" class="form-control" placeholder="Name*" required autocomplete="off">
                                        </div>
                                        <div class="col-sm-4 pb-4 pl-md-4">
                                            <input type="email" name="email_id" id="email_id" class="form-control" placeholder="Email*" autocomplete="off" required>
                                        </div>
                                        <div class="col-sm-4 pb-4 pl-md-4">
                                            <input type="tel" name="mobile_no" id="mobile_no" class="form-control" placeholder="Mobile*" autocomplete="off" onkeyup="if (/\D/g.test(this.value))this.value = this.value.replace(/\D/g, '')" required>
                                        </div>
            ...
            <article class="clearfix pb-5">
                <div class="contact-flood ">
                    ...
                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2947.8145915058954!2d0.48401399099052017!3d51.59010558732047!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x47d8c40fa4ff866d%3A0xa806ccad95187c1c!2sIlford%20Trading%20Estate%2C%20Paycocke%20Rd%2C%20Basildon%20SS14%203DR%2C%20UK!5e0!3m2!1sen!2sin!4v1571493430219!5m2!1sen!2sin"class="w-100 h-100 mi-500" frameborder="0" style="border:0;" allowfullscreen=""></iframe>
