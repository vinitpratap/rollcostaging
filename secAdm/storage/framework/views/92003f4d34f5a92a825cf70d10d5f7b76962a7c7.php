...
<!--                                <th class="column-title">Check All (Delete) &nbsp; <input type="checkbox" class="deleteCross" id="checkAll"></th>-->
                                ...
                                <tr class="pointer">
                                    ...
                                    <td><?php echo e($value->com_emailAddress); ?></br>
                                        <?php if ($value->user_status == 2) { ?>
                                            <a href="https://rollingcomponents.com/autologin.php?email=<?php echo e($value->com_emailAddress); ?>&token=<?php echo e(base64_encode('rollinglogin')); ?>" target="_blank" >Login</a>
                                        <?php } ?>
                                    </td>
                                    ...
                                    <td>
                                        ...
                                        <a href="#" data-id="<?php echo e(base64_encode($value->u_id)); ?>" class="resendPwd">Re-send</a>
                                    </td>
                                    <!--<td class="last"><input type="checkbox" class="deleteCrossref" id="<?php echo e($value->crossref_id); ?>"></td>-->
                                    <td  class="last">
                                        <a href="javascript:void(0);" title="Edit" class="mr-4 ml-2 d-inline-block"><img data-id="<?php echo e(base64_encode($value->u_id)); ?>" class="editCustomer" src="<?php echo e(URL::asset('images/edit.svg')); ?>" alt=""></a> 
                                        <a href="<?php echo e(route('customer.del',base64_encode($value->u_id))); ?>"  title="Delete" class="d-inline-block delete confirmation"><img src="<?php echo e(URL::asset('images/delete.svg')); ?>" alt=""></a>
                                    </td>
                                    <?php if($case == 'unverified'): ?>
                                    <td class="last"><input type="checkbox" class="deleteCrossref" id="<?php echo e($value->u_id); ?>"></td>
                                    <?php endif; ?>
                                </tr>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            <?php } else { ?>
                ...
                <?php if (count($data) > 0) { ?>
                    <div class="row  m-0">
                        ...
                        <div class="col-6 text-right pl-0 pr-0 pb-3 clearfix"><a href="<?php echo e(route('customer.export',$routeValues)); ?>" class="btn btn-outline-secondary pl-4 pr-4 pt-2 pb-2  m-0" id="exporttoExcel"> <img src="<?php echo e(URL::asset('images/excel.svg')); ?>" class="pr-2" alt="Export to Excel"> Export all Customers </a></div>
                        <?php
                        $status = 0;
                        $text = '';
                        switch ($case) {
                        ...
                        <div class="col-12 text-right pl-0 pr-0 pb-3 clearfix"><a href="<?php echo e(route('customer.export',$routeValues)); ?>" class="btn btn-outline-secondary pl-4 pr-4 pt-2 pb-2  m-0" id="exporttoExcel"> <img src="<?php echo e(URL::asset('images/excel.svg')); ?>" class="pr-2" alt="Export to Excel"> Export <?php echo ucfirst($text); ?> Customers </a></div>
