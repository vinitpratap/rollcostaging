        ...
        <div class="x_panel row m-0">
                        ...
                        <tbody>
                            ...
                            <tr class="pointer">
                                ...
                                <td class="last">
                                    ...
                                    <?php if($apCount>0): ?><a href="<?php echo e(route('application.manage',$routeValues1)); ?>" title="Edit" class="mr-4 ml-2 d-inline-block">Application</a> <?php else: ?> NA <?php endif; ?>                                     
            ...
            <?php if (count($data) > 0) { ?>
                <div class="row  m-0">
                    ...
                    <div class="col-12 text-right pl-0 pr-0 pb-3 clearfix"><a href="<?php echo e(route('product.export',$routeValues)); ?>" class="btn btn-outline-secondary pl-4 pr-4 pt-2 pb-2  m-0" id="exporttoExcel"> <img src="<?php echo e(URL::asset('images/excel.svg')); ?>" class="pr-2" alt="Export to CSV"> Export to CSV </a></div>
