                ...
                <div class="table-responsive-md collRquest pb-4">
                    <table id="datatable" class="table table-striped ">
                        ...
                        <tbody>
                            ...
                            <tr class="pointer">
                               <td><?php echo e($i++); ?></td>
                                <td><?php echo e($value->mcat_nm); ?></td>
                                <td><?php if($value->mcat_status ==1): ?> Enable <?php else: ?> Disable <?php endif; ?></td>
                                <td class="last">
                                    <a href="javascript:void(0);" title="Edit" class="mr-4 ml-2 d-inline-block"><img data-id="<?php echo e(base64_encode($value->mcat_id)); ?>" class="editMCategory" src="<?php echo e(URL::asset('images/edit.svg')); ?>" alt=""></a> 
                                    <a href="<?php echo e(route('mcategory.delete',base64_encode($value->mcat_id))); ?>"  title="Delete" class="d-inline-block delete confirmation"><img src="<?php echo e(URL::asset('images/delete.svg')); ?>" alt=""></a>
                                </td>
                            </tr>
...
<div class="row pt-3">
    <div class="col-lg-12 col-md-12 col-12">
        <div class="x_panel newRequestForm">
            ...
            <form method="post" id="mcategoryRegister" action="<?php echo e(route('mcategory.register')); ?> "  enctype="multipart/form-data"> 
                ...
                <div class="row mt-4">
                    <div class="col-md-4 mb-3 padRig">
                        ...
                        <?php if($errors->has('mcat_nm')): ?>
                        <span class="help-block">
                            <strong><?php echo e($errors->first('mcat_nm')); ?></strong>
                        </span>
                        <?php endif; ?>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <?php if($errors->has('mcat_status')): ?>
                        <span class="help-block">
                            <strong><?php echo e($errors->first('mcat_status')); ?></strong>
                        </span>
                        <?php endif; ?>
                    ...
                    <div class="col-md-4 mb-3 padRig">
                        ...
                        <?php if($errors->has('mcat_image')): ?>
                        <span class="help-block">
                            <strong><?php echo e($errors->first('mcat_image')); ?></strong>
                        </span>
                        <?php endif; ?>
