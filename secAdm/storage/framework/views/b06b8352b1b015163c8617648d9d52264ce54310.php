...
<!--                <div class="row mt-4">                   
                ...
                <div class="row mt-4">
                    <div class="col-12  pb-3 clearfix">
                        ...
                        <label for="spearOEM_file"> File</label>
                        <input  name="spearOEM_file" type="file" id="spearOEM_file" >        <a href="<?php echo e(URL('Demo')); ?>/demo-SpearReplaceOEMNumber.csv" class="d-block "> Download sample file</a> </div>
