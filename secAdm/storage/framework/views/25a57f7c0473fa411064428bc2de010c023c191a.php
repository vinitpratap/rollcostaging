            ...
            <div class="x_content row m-0">
                ...
                <div class="col-lg-6 col-sm-5 col-12 col-xl-7  mt-5 float-right ml-auto pr-0">
                    <table class="tile_info bg-light mt-2">
                        ...
                        <tr>
                            <td><i class="fa fa-square  lightGreen"></i>Pending  - <strong id="new_req_count"><?php echo e($reqData['new_req_count']); ?></strong></td>
                        </tr>
                        <tr>
        ...
        <div class="col-12 dashboard_graph borRadiShad">
            ...
            <div class="row m-0">
                <div class="col-lg-9 col-md-9 col-12 mt-4" id="graph-container">
                    ...
                    <input type="hidden" id="cancel_req" value="<?php echo e($reqData['cancelReqArr']); ?>">
                ...
                <div class="col-lg-3 col-md-3 col-12 bg-white pt-5">
                    ...
                    <div class="col-lg-12 col-md-12 col-12 mb-2 mb-xl-0">
                        ...
                        <div class="col pl-0 pr-0 pt-3">
                            <p class="mb-2 size-12">Cancelled Requests - <strong class="text-warning float-right"><?php echo e($reqData['canceled_req_count']); ?></strong></p>

                            <div class="progress progress_sm">
                                <div class="progress-bar bg-warning" role="progressbar" data-transitiongoal="<?php echo e($reqData['canceled_req_count']); ?>"></div>
