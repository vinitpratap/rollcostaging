                        ...
                        <table class="table table-striped ">
                            ...
                            <tbody>
                                ...
                                <tr class="pointer">
                                    ...
                                    <td class="last"><input type="checkbox" class="deleteSNF deleteCrossref" id="<?php echo e($value->snf_id); ?>"></td>
                                </tr>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<div class="clearfix"></div>
                ...
                <?php if (count($data) > 0) { ?>
                    <div class="row  m-0">
                        ...
                        <div class="col-12 text-right pl-0 pr-0 pb-3 clearfix"><a href="<?php echo e(route('search_nf.export',$routeValues)); ?>" class="btn btn-outline-secondary pl-4 pr-4 pt-2 pb-2  m-0" id="exporttoExcel"> <img src="<?php echo e(URL::asset('images/excel.svg')); ?>" class="pr-2" alt="Export to Excel"> Export Last 30 days search analytic data </a></div>

                    </div>
<div class="row  m-0">
                        <?php $routeValues = '?search=' . app('request')->input('search'); ?>
                        <div class="col-12 text-right pl-0 pr-0 pb-3 clearfix"><a href="<?php echo e(route('search_nfall.export',$routeValues)); ?>" class="btn btn-outline-secondary pl-4 pr-4 pt-2 pb-2  m-0" id="exporttoExcel"> <img src="<?php echo e(URL::asset('images/excel.svg')); ?>" class="pr-2" alt="Export to Excel"> Export All Search not found data </a></div>
