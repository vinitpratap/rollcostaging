...
<!--                                <th class="column-title">Check All (Delete) &nbsp; <input type="checkbox" class="deleteCross" id="checkAll"></th>-->
                        ...
                        <tbody>
                            ...
                            <?php if (count($data) > 0) { ?>
                                ...
                                <tr class="pointer">
                                    ...
                                    <td  class="last">
                                        <a href="javascript:void(0);" title="Edit" class="mr-4 ml-2 d-inline-block"><img data-id="<?php echo e(base64_encode($value->u_id)); ?>" class="restoreDelCustomer" src="<?php echo e(URL::asset('images/edit.svg')); ?>" alt=""></a> 
                ...
                <?php if (count($data) > 0) { ?>
                    <div class="row  m-0">
                        ...
                        <div class="col-6 text-right pl-0 pr-0 pb-3 clearfix"><a href="<?php echo e(route('customer.export',$routeValues)); ?>" class="btn btn-outline-secondary pl-4 pr-4 pt-2 pb-2  m-0" id="exporttoExcel"> <img src="<?php echo e(URL::asset('images/excel.svg')); ?>" class="pr-2" alt="Export to Excel"> Export Deleted Customers </a></div>
