...
<?php } ?>
                <li class="nav-item pl-3 pr-3"> <a href="javascript:;" class="user-profile dropdown-toggle nav-link" data-toggle="dropdown" aria-expanded="false"> <i class="fa fa-user"></i> Rolling components<span class=" fa fa-angle-down"></span> </a>
