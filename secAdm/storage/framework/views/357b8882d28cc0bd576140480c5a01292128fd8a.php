            ...
            <form method="post" id="spearServiceRegister" action="<?php echo e(route('spearService.upload')); ?> " enctype="multipart/form-data">
                ...
                <div class="row mt-4">
                    <div class="col-12  pb-3 clearfix">
                        ...
                        <a href="<?php echo e(URL('Demo')); ?>/demo-SpearServiceNumber.csv"><button type="button" class="btn btn-secondary pl-4 pr-4 pt-2 pb-2  m-0 text-uppercase" id="downloadspearOEM">Sample Format</button></a>
