...
<?php if (count($data) > 0) { ?>
    ...
    <?php $routeValues = 'search=' . app('request')->input('search'); ?>
                    <div class="col-12 text-right pl-0 pr-0 pb-3 clearfix"><a href="<?php echo e(route('crossref.export',$routeValues)); ?>" class="btn btn-outline-secondary pl-4 pr-4 pt-2 pb-2  m-0" id="exporttoExcel"> <img src="<?php echo e(URL::asset('images/excel.svg')); ?>" class="pr-2" alt="Export to Excel"> Export to Excel </a></div>
            ...
            <form method="post" id="categoryRegister" action="<?php echo e(route('crossref.register')); ?> " enctype="multipart/form-data"> 
                ...
                <div class="row mt-4">
                    <div class="col-12  pb-3 clearfix">
                        ...
                        <a href="<?php echo e(URL('Demo')); ?>/demo-CrossRef.csv"><button type="button" class="btn btn-secondary pl-4 pr-4 pt-2 pb-2  m-0 text-uppercase" id="downloadspearOEM">Download Sample</button></a>
                    </div>
                </div>
            </form>
        </div>
