...
//                 dd($productArr);
                        for ($i = 0; $i < count($productArr); $i++) {
                            ...
                            $AcCode = remove_accents($AcCode);
                            $PartName = remove_accents($PartName);
                            $Currency = remove_accents($Currency);
...
//                            $gr_id = $id;
                                if ($AcCode != '') {
                                    ...
                                    if (isset($grid) && $grid > 0) {
                                        ...
                                        DB::table('rollco_ms_group_logs')->insert(
                                                ['gr_nm' => $AcCode, 'gr_currency' => $Currency, 'grstt' => 'Exist', 'grudate' => date('Y-m-d H:i:s')]
                                        );
                                    } else {
                                        $grdata = ['gr_nm' => $AcCode, 'gr_currency' => $Currency,
                                            'gr_status' => 1];
                                        ...
                                        DB::table('rollco_ms_group_logs')->insert(
                                                ['gr_nm' => $AcCode, 'gr_currency' => $Currency, 'grstt' => 'Insert', 'grudate' => date('Y-m-d H:i:s')]
                                        );
                                    }
                                } else {
                                    DB::table('rollco_ms_group_logs')->insert(
                                            ['gr_nm' => $AcCode, 'gr_currency' => $Currency, 'grstt' => 'Skip', 'grudate' => date('Y-m-d H:i:s')]
                                    );
                                }
                                ...
                                if ($prstatus) {
                                    ...
                                    DB::table('rollco_ms_grproduct_log')->insert(
                                            ['GroupName' => $AcCode, 'Currency' => $Currency, 'PartName' => $PartName,
                                                'Price' => $Price, 'status' => 'Exist']
                                    );
                                } else {
...
//                    var_dump($data);
                                    ...
                                    DB::table('rollco_ms_grproduct_log')->insert(
                                            ['GroupName' => $AcCode, 'Currency' => $Currency, 'PartName' => $PartName,
                                                'Price' => $Price, 'status' => 'Insert']
                                    );
                                }
                            } else {
                                DB::table('rollco_ms_grproduct_log')->insert(
                                        ['GroupName' => $AcCode, 'Currency' => $Currency, 'PartName' => $PartName,
                                            'Price' => $Price, 'status' => 'Skip']
                                );
                            }
                        }
...
//            dd($data);
    ...
    public function exportToExcelGroup(Request $request) {
