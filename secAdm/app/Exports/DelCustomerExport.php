...
class DelCustomerExport implements FromCollection, WithHeadings {
    ...
    public function collection() {
        ...
        $query = DB::table('rollco_ms_users_deleted')
        ...
        if (!empty($this->search)) {
            ...
            $query = $query->where(function($query) use ($ser) {
                $query->where('companyName', 'LIKE', '%' . $ser . '%');
                $query->orWhere('com_emailAddress', 'LIKE', '%' . $ser . '%');
                $query->orWhere('com_Telephone', 'LIKE', '%' . $ser . '%');
                $query->orWhere('com_city', 'LIKE', '%' . $ser . '%');
                $query->orWhere('com_zipCode', 'LIKE', '%' . $ser . '%');
            });
        }
