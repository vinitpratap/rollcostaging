...
<link rel="icon" href="{{ URL::asset('images/favicon.png') }}" type="image/ico">
<title>Rollingcomponents</title>
<!-- Bootstrap -->
...
<link href="{{ URL::asset('css/datepicker/daterangepicker.css') }}" rel="stylesheet">
