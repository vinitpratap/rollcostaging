        ...
        <div class="x_panel row m-0">
                        ...
                        <table class="table table-striped ">
                            ...
                            <tbody>
                                ...
                                <tr class="pointer">
                                    <td>{{$value->sc_date}}</td>
                                    <td>
                                        {{$value->full_name .'('.$value->post_code.')'}}
                                        <?php if ($value->temp_id > 0) { ?>
                                            <a href="{{route('tempuser.getdata',base64_encode($value->temp_id))}}">(Temp User)</a>
                                        <?php } ?>
                                    </td>
                                    ...
                                    <td class="last">
                                        <?php if (isset($ss_id) && $ss_id != '') { ?>
                                            <a href="javascript:void(0);" title="Edit" class="mr-4 ml-2 d-inline-block btn btn-secondary viewAptlogs" data-id="{{$ss_id}}" data-uid="{{$value->u_id}}">Log Details</a> 
                                        <?php } else { ?>
                                            <span>N/A</span>
                                        <?php } ?>
                                    </td>
            ...
            <?php if (count($data) > 0) { ?>
                <div class="row  m-0">
                    ...
                    <div class="col-12 text-right pl-0 pr-0 pb-3 clearfix"><a href="{{route('report.export',$routeValues)}}" class="btn btn-outline-secondary pl-4 pr-4 pt-2 pb-2  m-0" id="exporttoExcel"> <img src="{{ URL::asset('images/excel.svg') }}" class="pr-2" alt="Export to Excel"> Export Sales Report </a></div>
                    <div class="col-12 text-right pl-0 pr-0 pb-3 clearfix"><a href="{{route('log.export',$routeValues)}}" class="btn btn-outline-secondary pl-4 pr-4 pt-2 pb-2  m-0" id="exporttoExcel"> <img src="{{ URL::asset('images/excel.svg') }}" class="pr-2" alt="Export to Excel"> Export Sales Logs </a></div>
                    <div class="col-12 text-right pl-0 pr-0 pb-3 clearfix"><a href="{{route('calusers.export')}}" class="btn btn-outline-secondary pl-4 pr-4 pt-2 pb-2  m-0" id="exporttoExcel"> <img src="{{ URL::asset('images/excel.svg') }}" class="pr-2" alt="Export to Excel"> Export Calender Users </a></div>
