                    ...
                    <table class="table table-striped ">
                        ...
                        <tbody>
                            ...
                            <tr class="pointer">
                                ...
                                <td class="last">
                                    <a href="{{route('enquiry.delete',base64_encode($value->id))}}"  title="Delete" class="d-inline-block delete confirmation"><img src="{{ URL::asset('images/delete.svg') }}" alt=""></a>
                                    
                                    

                                </td>
                                <td class="last"><input type="checkbox" class="deleteEnquiry" id="{{$value->id}}"></td>
...
<?php if (count($data) > 0) { ?>
                <div class="row  m-0">
                    ...
                    <div class="col-12 text-right pl-0 pr-0 pb-3 clearfix"><a href="{{route('enquiry.export',$routeValues)}}" class="btn btn-outline-secondary pl-4 pr-4 pt-2 pb-2  m-0" id="exporttoExcel"> <img src="{{ URL::asset('images/excel.svg') }}" class="pr-2" alt="Export to Excel"> Export to Excel </a></div>
