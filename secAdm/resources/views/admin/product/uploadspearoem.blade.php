...
<div class="row pt-3">
    <div class="col-lg-12 col-md-12 col-12">
        <div class="x_panel newRequestForm">
            ...
            <form method="post" id="spearOEMRegister" action="{{route('spearOEM.upload')}} " enctype="multipart/form-data">
                {{ csrf_field() }}
                @if (count($errors) > 0)
...
<!--                <div class="row mt-4">                   
                ...
                <div class="row mt-4">
                    <div class="col-12  pb-3 clearfix">
                        ...
                        <label for="spearOEM_file"> File</label>
                        <input  name="spearOEM_file" type="file" id="spearOEM_file" >        <a href="{{URL('Demo')}}/demo-SpearReplaceOEMNumber.csv" class="d-block "> Download sample file</a> </div>
