...
error_reporting(0);
    ...
    $snm = '';
    $snmp = '';
    $siteurl = "https://staging.rollingcomponents.com/" . $snm;
    $sitesurl = "https://staging.rollingcomponents.com/" . $snm;
    $siteurlnew = "https://staging.rollingcomponents.com/" . $snm;
    $siteurlnew1 = "https://staging.rollingcomponents.com/" . $snm;
    error_reporting(0);
}
