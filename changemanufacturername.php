...
//code start for import Profile Change
            ...
            $CORRECT_MANUFACTURER = trim($data[1]);

            
            if ($MANUFACTURER != "" && $CORRECT_MANUFACTURER != "") {
					$updateSql = "UPDATE  rollco_ms_crossref SET crossref_make='".$CORRECT_MANUFACTURER."' where crossref_make='".$MANUFACTURER."'";
					$sq->query($updateSql);
					$updatecount++;
            }
...
//exit;
    ...
    echo "<script>location.href='changemanufacturername.php?inscnt=".$insertcount."&updcnt=".$updatecount."&notuploadcnt=".$notuploadedcount."';</script>";
                                ...
                                <td> <table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0" >
                                        <tr> 
                                            <td> <table width="100%%" border="0" cellspacing="0" cellpadding="0">
                                                    <tr> 
                                                        <td height="400" align="left" valign="top"><form action="changemanufacturername.php" method="post" enctype="multipart/form-data" name="form1" class="text09" onSubmit="return validate_import();">
                                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                    <tr>
                                                                        <td colspan="2" class="txt5" style="padding-bottom: 20px">Change Manufacturer Name Crossref</td>
                                                                    </tr>
                                                                    <tr>
...
<?php if (isset($_GET['inscnt']) || isset($_GET['updcnt']) ||  isset($_GET['notuploadcnt'])) { ?>
                                                                                    ...
                                                                                    <br /><br /><br />
                                                                                    <a style="color: #000" href="changemanufacturername.php">Back to Change Manufacturer Name Crossref</a>
                                                                                    <?php
                                                                                } else
