...
com_city='" . str_replace("'", "", $TOWN) . "',
com_state='" . str_replace("'", "", $COUNTY) . "',
Country='" . str_replace("'", "", $COUNTRY) . "',
com_Telephone='" . str_replace("'", "", $Telephone) . "',
com_Fax='" . str_replace("'", "", $Fax) . "',
companyAccountPerEmail='" . str_replace("'", "", $acemail) . "',
role='" . str_replace("'", "", $Role) . "',
companyWebsite='" . str_replace("'", "", $Website) . "',
    
companyRegistrationNumber='" . str_replace("'", "", $regno) . "',
companyVatNumber='" . str_replace("'", "", $vat) . "',
    
companyAccountPerName='" . str_replace("'", "", $AccountPersonname) . "',

regisdate='" . str_replace("'", "", $Registrationdate) . "',
OtherEmailId='" . str_replace("'", "", $otheremail) . "',
OtherPWD='" . str_replace("'", "", $otherpwd) . "',
ANOTHEREmailId='" . str_replace("'", "", $ANOTHERemail) . "',
ANOTHERPWD='" . str_replace("'", "", $ANOTHERpwd) . "',
