                    ...
                    <table  border="0" cellspacing="0" cellpadding="0" width="100%">
                        ...
                        <tr>
                            <td style="font-size:16px; color:#4d4d4f;line-height:24px;font-family:Arial, sans-serif; padding:30px 30px 20px"> 	
                                ...
                                Thank you for your Registration with Rolling Components. Please click on the link below to verify your account:<a href="<?php echo $vlink; ?>"><?php echo $vlink; ?></a></td>
                        </tr>
                        <tr>
