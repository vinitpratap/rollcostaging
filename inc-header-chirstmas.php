...
<div class="topHeader bgheader">
    <header class="clearfix topSol">
        <div class="container clearfix">
            <div class="row solIcon ">
                <div class=" col-lg-6 col-md-8 col-sm-8 col-7 solLef align-self-center pr-0">
                ...
                <div class=" col-lg-6 col-md-4 col-sm-4 col-5 pl-0 solRig text-right align-self-center"> <a href="https://www.facebook.com/rollco1979/" class="mr-2" target="_blank"><img src="images/facebook.svg" alt="facebook"/></a> <a href="https://twitter.com/rollingcomp" class="mr-2" target="_blank"><img src="images/twitter.svg" alt="twitter"/></a> 
                
                
                <a href="#" class="mr-2" target="_blank"> <img src="images/linkedin.svg"  alt="linkdin"/></a>
                
                
                <a href="https://www.instagram.com/rollco01/" class="mr-2" target="_blank"><img src="images/instagram.svg" alt="Instagram"/></a> <a href="https://www.youtube.com/channel/UCKOi7APb9LtAFX_pFFs0yMA/" class="" target="_blank"><img src="images/youtube2.svg" alt="linkedin"/></a> </div>
            </div>
        </div>
    </header>

    <nav class="navabarAll nav align-self-center navbar-expand-lg christmas" >
        <div class="container">
            <div class="row mr-0">
    ...
    <li > <a href="blog/" class="<?php if ($cpage
