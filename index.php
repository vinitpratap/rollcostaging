    ...
    <body>
        ...
        <section class="clearfix">
            <article class="clearfix">
                <div class="container-fluid p-0">
                    <div id="bannerSlider" class="owl-carousel owl-theme" >
                        <div class="item position-relative h-100"> <img src="images/banner.jpg"  alt="banner">
                            <div class="position-absolute h-100 d-flex">
                                <div class="mb-6 mt-auto w-100">
                                    <h2> ALWAYS NEW
                                        <hr> </h2>
                        ...
                        <div class="item position-relative h-100">  <img src="images/banner3.jpg"  alt="banner">
                            <div class="position-absolute h-100 d-flex">

                                <div class="mt-auto mb-6 w-100">
                        ...
                        <div class="item position-relative  h-100"> <img src="images/banner2.jpg"  alt="banner">
                            <div class="position-absolute h-100 d-flex ">
                                <div class="mb-6 mt-auto  w-100">
                        ...
                        <?php /* ?><div class="item position-relative"> <img src="images/banner3.jpg"  alt="banner">
                    ...
                    <div class="bannerImg"><img src="images/cor-grey3_homebanner.png" alt="Grey banner of Automotive Parts Manufacturing Company" class="w-100"> </div>
                </div>
            </article>
                ...
                <div class="container">
                    <div class="row justify-content-center ">
                        <div class="col-12 col-lg-6 col-sm-10 col-md-8 p-40 text-center">
                            ...
                            <p class=" font20 text-white onlintext">  <a  href="listing.php" > ONLINE CATALOGUE <i class="d-inline-block pl-2"> <img src="images/arrow.png" class="img-fluid"   alt="arrow"></i></a> </p> 
                            <form action="product-detail.php" class="vehicLook" method="post">
                                <div class="input-field">
                                    ...
                                    <ul id="searchResult1" class="resList"></ul>
            ...
            <article class="clearfix welcomeTo pt-5 pb-5 aos-item" data-aos='fade-up'>
                <div class="container ">
                    <div class="row justify-content-center">
                        <div class=" col-xl-10 col-lg-10 col-md-12 text-center position-relative">
                            <div class="fortYear position-absolute">

                            </div>
                            <h2 class="text-danger"> WELCOME TO ROLLING COMPONENTS</h2>
                            <h3 class="pb-4 mb-2 lighgrey">PROUDLY OFFERING AFTERMARKET AUTO PARTS SINCE 1979</h3>
                            <img src="images/fourty-years-logo.png" alt="Rolling Components 40+ years of experience" class="pb-4 imsize"  >
                        </div>
                    </div>
                </div>

                <div class="someRollco mbr-parallax-background w-100 pt-5">
                    ...
                    <div class="container  clearfix">
                        ...
                        <div class="row ml-0 mr-0 pt-3 justify-content-between row-flex pb-4 mbrSection aos-item" data-aos='fade-up'>
                            ...
                            <div class="col-md-3 col-lg-2  text-center p-45">
                                <div class=" p-2 bg-danger"> <span class="pt-2 d-block"><img src="images/hm-ic-2.svg" class="img-fluid" alt="PRODUCTS IN"> </span>
                                    <h2 class=" pt-2 numscroller display-4 text-white font-weight-500" data-slno='2' data-min='0' data-max='300000' data-delay='12000' data-increment="12000">0 </h2>
                            ...
                            <div class="col-md-3 col-lg-2  text-center p-45">
                                <div class=" p-2 bg-danger"> <span class=" pt-2 d-block"><img src="images/hm-ic-3.svg" class="img-fluid" alt="DELIVERIES"> </span>
                                    <h2 class=" pt-2  numscroller display-4 text-white font-weight-500" data-slno='3' data-min='0' data-max='60000' data-delay='15000' data-increment="15000">0</h2>
                            ...
                            <div class="col-md-3 col-lg-2  text-center p-45">
                                <div class=" p-2 bg-danger"> <span class="pt-2 d-block"><img src="images/hm-ic-4.svg" class="img-fluid" alt="SQUARED METERS"> </span>
                                    <h2 class=" pt-2 numscroller display-4 text-white font-weight-500" data-slno='4' data-min='0' data-max='90000' data-delay='20000' data-increment="20000">0</h2>
                        ...
                        <div class="row justify-content-center callAnsw ">
                            <div class="col-lg-9 col-md-12">
                                <div class="row  pt-3 justify-content-between row-flex pb-4 mbrSection aos-item" data-aos='fade-up'>
                                    <div class="col-md-3 col-lg-2 text-center p-45 ">
                                    ...
                                    <div class="col-md-3 col-lg-2  text-center p-45">
                                        <div class=" p-2 bg-danger">
                                            ...
                                            <p class="font14 mb-1"><strong>Max Calls answered</strong> 
                                                Low waiting period </p>
                                        </div>
                                    </div>
                                    <div class="col-md-3 col-lg-2  text-center p-45">
                                        <div class=" p-2 bg-danger"> 
                                            <span class="pt-2 d-block"><img src="images/hm-ic-7.svg" class="img-fluid" alt="SQUARED METERS"> </span>
                                            <p class="font14 mb-1"> <strong>Next day</strong>
                                                free delivery UK & MAINLAND <br/>(SEE T&C) 
                                            </p>
                                        </div>
                                    </div>
...
<!--                            <p class=" font15 pl-2  mb-3 "><strong>ROLLCO</strong> is one of the leading company in United Kingdom in the distribution of auto parts and services to support the work of spare part dealers.</p>
<p class=" font15 pl-2  mb-3 "><strong>ROLLCO</strong>, founded in 1962, has vigorously pursued a history of continuous success and today it represents an innovative and evolving company.</p>
<p class=" font15 pl-2  mb-1 ">We are a benchmark in the automotive industry for manufacturers and resellers, for the organizational virtues, cutting-edge logistics,
prestigious brand distribution, the partnerships with automotive networks, and smart technical and marketing services for its dealers.</p>-->
            ...
            <article class="clearfix rollcoBest pt-5 pb-0 aos-item rollco-ie" data-aos='fade-up'>
                <div class="contImg position-relative">
                    <img src="images/cor-grey4_homespareparts.svg" alt="Banner" class="w-100">
                    <div class="position-absolute best-choice">
                        <div class="container">
                            <div class="row pt-3 rollcorow">
                                <div class="col-12 text-center pt-5 pt-md-0">
                                    <h2 class="text-danger">ROLLCO</h2>
                                    <h3 class="pb-0 mb-0 lighgrey">YOUR BEST CHOICE FOR SPARE PARTS</h3>
                ...
                <div class="rollcoBesBg">
                    <div class="container">
                        <div class="row rollcorow">
                            <div class="col-12 text-center pt-md-0">
                                <span class="d-block p-4 arrowdown"><img src="images/rollco-icon.svg" alt="Arrow"></span> 
                            </div>
                        </div>
                        <div class="row pt-lg-2 pt-md-3 d-flex rollCol justify-content-between">
            ...
            <?php /* ?><article class="clearfix pt-5 pb-5 aos-item accRedi" data-aos='fade-up'>
              <div class="container">
              <div class="row pt-3">
              <div class="col-12 text-center">
              ...
              <img src="images/certificate.jpg" alt="no images" class=" pt-lg-5 pb-lg-5 pt-sm-3 pb-sm-3 img-fluid">
              </div>
              </div>
              </div>
              </article><?php */ ?>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-12 col-sm-10 text-center">
                            <div class="embed-responsive embed-responsive-16by9">
                                <iframe src="" class="embed-responsive-item" data-src="https://www.youtube.com/embed/299sMXFV-jw" allowfullscreen></iframe>
                                <script>
                                    function init() {
...
<style>
body.modal-open .topHeader{ z-index:999 }
#exampleModalCenter .modal-body{ padding:15px; height:auto!important;  }
.popCovid { max-width:700px; padding:0px; background-color:#FFF; width: 95%; position: relative;}
.popCovid img{ width:100%; height:auto;}
#exampleModalCenter .close{/*position:absolute; top: 30px; right:20px;*/ color: #ff0000; z-index: 99    }
</style>

<?php 
$popupSql = "SELECT p_title,p_content,p_image FROM rollco_ms_popup WHERE p_status = 1 ORDER BY p_id DESC LIMIT 1";

$popupnrow = $sq->numsrow($popupSql);

if($popupnrow > 0){
	$popupData = $sq->fearr($popupSql);
	
?>

        <div class="modal fade col-lg-12 show" id="exampleModalCenter" >
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content popCovid">
                    <div class="modal-body text-center">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>

<div align="center">
<strong style="color:#ff0000;font-size: 20px;"><?php echo $popupData['p_title'];?>
</strong>
</div>
<div align="justify"><br>
<?php echo $popupData['p_content'];?>
</div>
<img src="upload/popup/<?php echo $popupData['p_image'];?>"/>
                 </div>
