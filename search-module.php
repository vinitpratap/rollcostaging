                                    ...
                                    <div id="search-by-car" class="tab-pane ">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 col-12 input-field ">
                                                <form action="vehicle-lookup-search.php" class="vehicLook" method="post">
                                                    ...
                                                    <select class="form-control mb-3" id="select_product" required name="cat_id"  >
                                                        ...
                                                        <option value="0" <?php if ($_POST['cat_id'] == 0) {
                                        echo "selected";
                                    } ?>>All</option> 
                                                        <?php
                                                    ...
                                                    if (isset($_POST['cat_id']) && $_POST['cat_id'] == $rs['cat_id']) {
                                                        echo 'selected';
                                                    }
                                                                ?>
                                                                        > <?php echo strtoupper($rs['cat_nm']); ?> </option> 
        <?php }
    }
    ?>
                                                    ...
                                                    <img src="images/gb.jpg" /> <input type="text" name="car_number" class="bgcange" id="car_number" placeholder="Enter Your Reg No" autocomplete="off" required value="<?php
