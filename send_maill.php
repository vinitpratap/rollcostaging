...
$API_KEY='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';//removed old one on 10thmarchSG.U1_ivg9QT-mAQsj1B5awNA.vcehWuL1vdd9KWzlYNdAWKIVzFhLbB9mb-G88GmRMXA
$fromEml = new SendGrid\Email(null, $FROM_EMAIL);
/*$subject = "Testing rollco email";
$htmlContent = 'Welcome to Rollco';
$TO_EMAIL = 'sanjit.bhardwaj@studiobrahma.in';
